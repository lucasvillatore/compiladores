#ifndef __tabelasimbolos__
#define __tabelasimbolos__
...
void adiciona_simbolo(simbolo_t *simbolo, tabela_simbolos_t *tabela)
{
    tabela->topo++;
...
simbolo_t *remove_simbolo(tabela_simbolos_t *tabela)
{
    simbolo_t *simbolo;
    if (tabela->topo == -1) {
        return NULL;
...
void remove_multiplos(tabela_simbolos_t *tabela, int quantidade)
{
    while(quantidade > 0) {
        remove_simbolo(tabela);
        quantidade--;
    } 
}
...
void atualiza_tipo_variaveis(tabela_simbolos_t *tabela, int tipo_variavel, int num_vars)
{
