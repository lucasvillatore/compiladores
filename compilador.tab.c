...
{
       0,    53,    53,    53,    67,    66,    70,    73,    73,    76,
      77,    81,    86,    81,    94,    96,   100,   113,   130,   131,
     134,   134,   137,   138,   142,   146,   150,   159,   170,   184,
     193,   198,   205,   212,   216,   217,   221,   222,   223,   224,
     225,   226,   230,   231,   232,   236,   237,   241,   242,   243,
     244,   246,   250,   255,   260,   269,   270,   271
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "DO", "MAIS", "MENOS", "MULTIPLICACAO", "OR", "AND", "NOT",
  "ABRE_COLCHETES", "FECHA_COLCHETES", "IGUAL", "MENOR", "MAIOR",
  "DIFERENTE", "MAIOR_IGUAL", "MENOR_IGUAL", "READ", "WRITE", "FALSE",
  "TRUE", "INTEGER", "DIV", "NUMERO", "BOOLEAN", "$accept", "programa",
  "$@1", "bloco", "$@2", "parte_declara_vars", "var", "declara_vars",
  "declara_var", "$@3", "$@4", "tipo", "lista_id_var", "lista_idents",
  "comando_composto", "comandos", "comando", "comando_sem_rotulo",
  "atribuicao", "variavel_atribuicao", "variavel", "numero", "boolean",
  "expressao", "expressao_simples", "relacao", "termo_com_sinal", "termo",
  "fator", "operacao", "operacao_fator", YY_NULLPTR
};
#endif
...
{
     -49,     7,    28,   -49,     1,    22,    31,   -49,    32,    45,
      40,    42,   -49,   -49,    26,   -49,   -49,    43,   -49,    44,
     -49,    48,   -49,   -49,    21,    23,   -49,    46,   -42,   -49,
     -49,    49,    54,   -49,   -49,    41,   -49,   -49,   -49,   -49,
     -49,    50,    -4,    55,   -49,    -4,   -49,    -2,    -2,    -2,
     -49,   -49,   -49,   -49,   -49,   -49,   -18,   -15,   -49,   -21,
     -49,   -49,    11,   -21,   -21,   -49,   -49,   -49,   -49,   -49,
     -49,   -49,    -4,   -49,   -49,   -49,    -2,   -49,   -49,   -49,
      -2,   -49,   -15,   -21,   -49
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     8,    18,    11,     0,     4,     6,     7,    10,     0,
       3,     0,     9,    17,     0,     0,     5,     0,     0,    21,
      27,     0,     0,    24,    25,     0,    16,    14,    15,    12,
      20,    23,     0,     0,    22,     0,    28,     0,     0,     0,
      31,    30,    29,    47,    48,    49,    26,    33,    35,    44,
      46,    13,     0,    42,    43,    51,    36,    38,    41,    37,
      40,    39,     0,    52,    53,    54,     0,    55,    57,    56,
       0,    50,    32,    34,    45
};
...
{
      -1,     1,     2,    14,    21,    15,    16,    17,    18,    19,
      43,    39,    24,     8,    26,    31,    32,    33,    34,    35,
      53,    54,    55,    56,    57,    72,    58,    59,    60,    76,
      80
};
...
{
      45,    65,    45,    37,    63,    64,    38,     3,    77,    46,
      78,    46,    73,    74,     5,    75,    81,    66,    67,    68,
      69,    70,    71,    47,    48,    79,     6,    27,    49,    28,
      49,     4,    84,    83,    29,    20,    30,     9,    10,    50,
      51,    50,    51,    52,     7,    52,    66,    67,    68,    69,
      70,    71,    11,    12,    13,    42,   -11,    23,    25,    36,
      40,    41,    61,    30,    22,    44,    82,     0,     0,     0,
      62
};

static const yytype_int8 yycheck[] =
{
       4,    49,     4,    45,    47,    48,    48,     0,    29,    13,
      31,    13,    27,    28,    13,    30,     5,    35,    36,    37,
      38,    39,    40,    27,    28,    46,     4,     6,    32,     8,
      32,     3,    80,    76,    11,     9,    13,     5,     6,    43,
      44,    43,    44,    47,    13,    47,    35,    36,    37,    38,
      39,    40,     7,    13,    12,    14,    13,    13,    10,    13,
      11,     7,     7,    13,    17,    41,    72,    -1,    -1,    -1,
      45
};
...
static const yytype_int8 yystos[] =
{
       ...
       6,     7,    13,    12,    52,    54,    55,    56,    57,    58,
       9,    53,    57,    13,    61,    10,    63,     6,     8,    11,
      13,    64,    65,    66,    67,    68,    13,    45,    48,    60,
      11,     7,    14,    59,    64,     4,    13,    27,    28,    32,
      43,    44,    47,    69,    70,    71,    72,    73,    75,    76,
      77,     7,    72,    76,    76,    77,    35,    36,    37,    38,
      39,    40,    74,    27,    28,    30,    78,    29,    31,    46,
      79,     5,    73,    76,    77
};
...
{
       0,    49,    51,    50,    53,    52,    54,    55,    55,    56,
      56,    58,    59,    57,    60,    60,    61,    61,    62,    62,
